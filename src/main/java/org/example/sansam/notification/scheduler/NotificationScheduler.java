...
public class NotificationScheduler {
    ...
    public void deleteExpiredNotification() {
        int deleted = notificationHistoryRepository.deleteByExpiredAtBefore(LocalDateTime.now());
...
//
//        // 결제 완료 상태 delivered_at 기준 하루 이상 지난 주문 조회
////        List<Order> deliveredOrders = orderRepository.findByDeliveredAtBeforeAndStatus_StatusId(oneDayAgo, STATUS_ORDER_PAID);
